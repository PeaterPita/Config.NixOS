...
ModuleBase {
        ...
        Item {
            ...
            Item {
                ...
                Column {
                    ...
                    ProgressBar {
                        width: parent.width
                        visible: showProgressBar && root.player !== null
                    }
                    PlayerDots {
                        width: parent.width
                        visible: showPlayerDots && Mpris.players.values.length > 1
                    }
                }
        ...
        Row {
            ...
            Repeater {
                ...
                delegate: Rectangle {
                    ...
                    height: 6
                    radius: 3
                    color: index === root.playerIndex ? Theme.colCyan : root.hoverColor
                    Behavior on width {
                        SpringAnimation {
                            spring: 4.5
                            damping: 0.35
    ...
    component MediaButton: Rectangle {
        ...
        Text {
            ...
            text: parent.text
            color: parent.enabled ? Theme.colFg : Theme.colMuted
            font.pixelSize: 18
        }
